            ...
            <div class="table-responsive">
                <table class="table table-hover table-bordered table-striped align-middle text-center mb-0">
                    <thead class="table-dark">
                        <tr>
                            <th scope="col"><i class="fas fa-id-badge me-1"></i>Mã Công Việc</th>
                            <th scope="col"><i class="fas fa-briefcase me-1"></i>Tên Công Việc</th>
                            <th scope="col"><i class="fas fa-users me-1"></i>Số Lương</th>
                        </tr>
                    </thead>
                    <tbody>
                        ...
                        <c:if test="${empty works}">
                            <tr>
                                <td colspan="5" class="text-center text-muted py-4">
                                    <i class="fas fa-info-circle me-2"></i> Hiện bạn không có công việc nào
                                </td>
                            </tr>
                        </c:if>
                    </tbody>
